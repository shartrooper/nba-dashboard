...
export const SIGN_IN = gql`${queryArranger([signInQuery], authBodyParams[SignIn], 'mutation')}`;
export const SIGN_UP = gql`${queryArranger([signUpQuery], authBodyParams[SignUp], 'mutation')}`;